...
export class EmailTemplateService {
  /**
   * Generate HTML template for new application notifications
   */
...
<body>
  ...
  /**
   * Generate HTML template for application status updates
   */
...
<body>
  ...
  /**
   * Generate HTML template for job published notifications
   */
